...
CREATE VIEW B AS
(
SELECT TOP 10 Name,Year,Rating,Genre,Budget,Gross,(Gross - Budget) Profit 
FROM Movies 
...
--Top 10 Best Selling vs Worst Selling Movies Comparison 
...
--Movies with the highest profit ratio 
